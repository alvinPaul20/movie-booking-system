...
<?php
    // Default time
        ...
        $sql = "SELECT seat_no FROM `seat_detail` WHERE show_time = '$selected_time' && theater_no = '2'";
        ...
        $sql1 = "SELECT * FROM `seat_detail` WHERE theater_no = 2";
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        ...
                        <i class="fa-regular fa-clipboard"></i> <span class="ms-1 d-none d-sm-inline">Bookings</span> </a>
                            ...
                            <li>
                                <a href="theater_2.php" class="nav-link px-0"  id="active"> <span class="d-none d-sm-inline">Theater</span> 2</a>
                            </li>
                            <li>
...
<div class="row d-flex flex-column justify-content-even ">
                ...
                <div class="col-10 p-5 d-flex justify-content-center align-items-center  ">
                    <button class=" btn btn-primary me-3"><a class="text-white text-decoration-none" href="theater_2.php?time=8:30">8:30</a></button>
                    <button class=" btn btn-primary me-3"><a class="text-white text-decoration-none" href="theater_2.php?time=12:30">12:30</a></button>
                    <button class=" btn btn-primary me-3"><a class="text-white text-decoration-none" href="theater_2.php?time=15:30">15:30</a></button>
                    <button class=" btn btn-primary me-3"><a class="text-white text-decoration-none" href="theater_2.php?time=19:30">19:30</a></button>
                </div>
