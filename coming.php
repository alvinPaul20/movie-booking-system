...
$default_sql = "SELECT * FROM movie WHERE theater_no = '0' ORDER BY id LIMIT 1";
$default_result = mysqli_query($link, $default_sql);
// Fetch the data for the default movie
$default_data = mysqli_fetch_array($default_result);

// Default movieid
$default_movieid = $default_data['id'];

$selected_movieid = isset($_GET['movieid']) ? $_GET['movieid'] : $default_movieid;


$sql = "SELECT movie.*, category.category_name 
        FROM movie 
        INNER JOIN category ON movie.category_id = category.id 
        WHERE movie.id = '" . mysqli_real_escape_string($link, $selected_movieid) . "'";
    ...
    <div class="offcanvas offcanvas-end bg-dark" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
          ...
          <li class="nav-item">
            <a class="nav-link mx-lg-3 active-page" href="coming.php">Coming Soon</a>
          </li>
          <li class="nav-item">
