...
<nav class="navbar navbar-expand-lg fixed-top">
  <div class="container">
    ...
    <a href="login.php" class="login-button  fs-6 fw-bold">Sign In</a>
...
<div id="carousel-id" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    ...
    foreach ($theater_no as $theater) {
        $active = ($theater == 1) ? 'active' : ''; // Mark first item as active
      ...
      <div class="carousel-caption  d-none d-md-flex">
        ...
        <p class="text-wrap text-start w-50"><?=$data['description']?>.</p>
         <p><i class="fa-regular fa-clock"></i> <?=$data['duration']?> </p>
          ...
          <a href="#"  onclick="buyConfirmation()" class="btn  btn-outline-info me-3 fw-bold">Buy</a>
          <a href="movies.php?theaterid=<?=$data['theater_no'] ?>" class="btn btn-outline-info me-3 fw-bold">Info</a>
          <a href="home.php?trailer=<?=$data['id'] ?>" class="btn  btn-outline-danger me-3"><i class="fa-solid fa-play"></i></a>
           <a href="home.php?trailer=<?=$data['id'] ?>" class='text-decoration-none text-white fw-bold'>Watch Trailer</a>
