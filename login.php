...
include('Controllers/safe-login.php')
?>
...
<div class="main-container d-flex">
        <div class="row d-flex w-100">
            ...
            <div class="col-lg-6  form-container d-flex flex-column mt-5">
                ...
                <div class="forms-email fs-6 fw-light my-1 text-white">
                    <form action="" method="post" role="form">
                        ...
                        <button type="submit" class="btn btn-danger w-100" name="login">Submit</button>
                    </form>
                </div>

                <div class="login">
                    <a href="register.php" class="text-decoration-none text-white d-flex justify-content-center">Register</a>
                </div>
            </div>
        </div>
    </div>
